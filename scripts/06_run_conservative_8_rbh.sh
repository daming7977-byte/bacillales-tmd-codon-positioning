...
PANEL="config/panel_conservative_8.tsv"
OUTDIR="work/orthology/rbh_conservative8"
TMPDIR="work/orthology/tmp_conservative8"
...
echo "=== Conservative 8-species RBH finished ==="
